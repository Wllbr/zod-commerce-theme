...
function fixture(reduced=false){
 ...
 section.querySelectorAll=s=>s.includes('slide')?slides:dots;section.querySelector=s=>({'[data-campaign-pause]':toggle,'[data-campaign-viewport]':viewport,'[data-campaign-next]':next,'[data-campaign-prev]':prev}[s]);
