...
assert.equal(calc({free_shipping_bar:null,sub_total:900}),null,'disabled offer stays hidden');
...
assert.equal(widget.hidden,true,'successful disabled-offer response hides progress');
