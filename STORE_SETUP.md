...
## Configure these in Salla Dashboard — not in the theme

Before styling homepage components, configure the store identity/logo/slogan, Arabic & English languages, currencies, advertisement bar, main/footer menus, categories, brands, contact information, social links, VAT/tax certificate, payment methods, shipping rules, product prices/offers/stock/options and reviews in Salla. The theme reads those sources directly.

For ZOD specifically, do **not** type the 500 SAR free-shipping rule, Jeddah same-day promise, product warranty duration, sale price or stock quantity into custom theme fields. Configure the actual commercial rule/product data in Salla, then use the theme only to promote it visually.

See `SALLA_NATIVE_INTEGRATION.md`.
