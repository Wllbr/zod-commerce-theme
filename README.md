> Current release: **v1.7.23** — restores the v1.7.13 shared product cards while preserving later product-page/Twilight fixes.

# ZOD Commerce Theme

**Version 1.7.23** — Salla Twilight storefront for ZOD.
